    ...
    <main class="container">
        ...
        <div class="jumbotron bg-success">
            <div class="container" style="margin-bottom: -165px;">
                <div id="DIV2">
                    <img src="/assets/images/section-3.jpg" alt="" height="200px" width="100%" style="margin: auto auto auto 165%;">
                </div>
        ...
        <div class="container">
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <div class="mx-auto">
                        <div class="card-body mt-3 ml-5">
                            <img src="/assets/images/section-4.png" alt="" height="350px" width="50%">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-2">
            <div class="col-md-6 bg-success">
                <img src="/assets/images/section-5.jpg" alt="" height="50%" width="75%" style="margin-top: -85px;margin-left: 150px;">
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                ...
                <img src="/assets/images/section-7.jpg" alt="" height="80%" width="75%" style="margin-left: 145px; margin-top: -90px;">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6 bg-light">
                <div class="mx-auto">
                    <div class="card-body mt-3 ml-5">
                        <img src="/assets/images/section-8.png" alt="" height="100%" width="50%" style="margin-top: -90px;">
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="card-deck mx-auto" style="justify-content: center">
                        <div class="card border-light" style="max-width: 18rem;">
                            ...
                            <img class="Card image cap" style="height: 100px;width: 25%;display: block;align-items: center;text-align: center;margin: auto;" src="/assets/images/card-1-img-section-9.png" alt="Card image cap">
                        </div>
                        ...
                        <div class="card border-light" style="max-width: 18rem;">
                            ...
                            <img class="Card image cap" style="height: 10%;width: 25%;display: block;align-items: center;text-align: center;margin: auto auto 10% auto;" src="/assets/images/card-3-img-section-9.png" alt="Card image cap">
                        </div>
                    </div>
                </div>
            </div>
