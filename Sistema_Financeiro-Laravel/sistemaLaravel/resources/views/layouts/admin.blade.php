...
<head>
  ...
  <title>Sistema financeiro Laravel - Gabriel Souza</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="/home" class="logo">
        ...
        <span class="logo-mini"><b>Sistema</b>Vendas</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Sistema - Vendas</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">Gabriel Souza</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <p>
                    www.gabrielbsouzadev.com.br - Desenvolvimento de Sistemas
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015-2020 <a href="#">Sistemas</a>.</strong> Todos os direitos reservados.
  </footer>
